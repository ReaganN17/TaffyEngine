...
public:
	...
	*/
	...
	/**
	* If enabled, does not schedule if checkRequirments returns true
	* 
	* @param enable
	*/
	void cancelSelf(bool enable);

	/**
	* If enabled, cancels events using requirements before scheduling
	*
	* @param enable 
	*/
	void cancelOthers(bool enable);
